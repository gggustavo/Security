  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        ' <div class="box1">' +
        '   <label></label>' +
        '   <span class="info-container col-md-10">' +
        '     <span class="info"></span>' +
        '     <button type="button" class="btn clear1 pull-right"></button><br />' +
        '   </span>' +
        '   <input class="filter" type="text" style="width: 225px;">' +
        '   <div class="btn-group buttons" style="width: 50px;">' +
        '     <button type="button" class="btn moveall" style="padding-left: 0px; padding-right: 0px;">' +
        '       <i></i>' +
        '       <i></i>' +
        '     </button>' +
        ...
        '   <span class="info-container col-md-10">' +
        '     <span class="info"></span>' +
        '     <button type="button" class="btn clear2 pull-right"></button><br />' +
        '   </span>' +
        '   <input class="filter" type="text" style="width: 225px;">' +
        '   <div class="btn-group buttons" style="width: 50px;">' +
        ...
        '       <i></i>' +
        '     </button>' +
        '     <button type="button" class="btn removeall" style="padding-left: 0px; padding-right: 0px;">' +
        '       <i></i>' +
        '       <i></i>' +
        '     </button>' +
        '   </div>' +
